...
function ControlsAndInput(){
	...
	this.mousePressed = function(){
        ...
        //if not make visualization fullscreen
	...
	this.draw = function(){
		...
		if(this.menuDisplayed){
            ...
            text("Press Play Button to start the soundtrack",300,70); // adding the text at the launch of music visualisation
            text("Press SpaceBar to select menu",450,110);
        }	
		pop();
